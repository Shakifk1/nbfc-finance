    ...
    <>
      ...
      <section className="bg-gray-50 text-gray-700 px-6 py-12 mt-28">
        ...
        <div className="text-center max-w-4xl mx-auto">
          <h2 className="text-4xl font-extrabold text-gray-800 mb-4 border-b-4 border-orange-600 pb-2" data-aos="fade-down">
            Empower Your Business Growth with Flexible Loan Solutions
          </h2>
          <p className="text-lg text-gray-800 leading-relaxed" data-aos="fade-up">
          ...
          <p className="text-lg font-semibold  mt-4" data-aos="fade-up">
            Tailored Business Loans to Fuel Your Ambitions
          </p>
          <p className="mt-2 text-gray-700" data-aos="fade-up">
            Low interest rates | Quick approvals | Flexible repayment options
          </p>
          {/* Highlighted Paragraph */}
          <p className="text-lg text-gray-600 font-medium bg-gray-100 p-4 rounded-lg text-center mt-6" data-aos="fade-up">
        ...
        <div className="mt-12 max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
          <h3 className="text-2xl font-bold text-gray-800 mb-4" data-aos="fade-up">What is a Business Loan?</h3>
        ...
        <div className="mt-12 max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
          <h3 className="text-2xl font-bold text-gray-800 mb-4" data-aos="fade-right">Types of Business Loans</h3>
        ...
        <section className="bg-gray-50 px-6 pt-12 text-gray-700">
          ...
          <div className="mt-12 flex flex-col md:flex-row items-center gap-6">
            <div className="bg-white shadow-lg rounded-lg p-6 w-full md:w-5/12" data-aos="fade-right">
          ...
          <div className="mt-12 flex flex-col md:flex-row-reverse items-center gap-6">
            <div className="bg-white shadow-lg rounded-lg p-6 w-full md:w-5/12" data-aos="fade-left">
      ...
      <div className="container mx-auto px-6 py-8 mt-8 bg-gray-50 rounded-lg shadow-lg">
        {/* Section Heading */}
        <h2 className="text-4xl font-extrabold text-gray-800 mb-6 text-center" data-aos="fade-down">
          Why Choose Us?
        </h2>

        {/* Description */}
        <p className="text-lg text-gray-800 text-center mb-8 leading-relaxed" data-aos="fade-down">
