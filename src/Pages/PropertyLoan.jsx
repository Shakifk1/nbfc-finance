  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 mt-24 bg-white shadow-lg rounded-lg">
        {/* Heading */}
        <h1 className="text-4xl font-extrabold text-gray-800 border-b-4 border-orange-600 inline-block pb-2" data-aos="fade-up">
      ...
      <div className="bg-gray-50 text-gray-800 min-h-screen py-10 px-5">
        <div className="max-w-4xl mx-auto space-y-6">
          {/* Title */}
          <h1 className="text-3xl font-bold text-gray-950 border-b-4 border-orange-600 pb-2">
          ...
          <h2 className="text-2xl font-semibold text-gray-800">Types of Property Loans</h2>
          ...
          {/* Use Cases */}
          <h2 className="text-2xl font-semibold text-gray-800">Use Cases for Property Loans</h2>
